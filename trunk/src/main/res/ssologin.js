function SSOController() {
    ...
    var customLogin, customPrepare, customLogout; (function() {
        var $empty = function() {},
        loginParam = {
            username: "",
            password: "",
    ...
    this.login = function(username, password, savestate) {
        ...
        ssoLoginTimer.start(me.loginTimeout,
        function() {
            ssoLoginTimer.clear();
    ...
    var excuteIframe = function(id, url) {
        ...
        addEventListener(new_iframe, "load",
        function() {
